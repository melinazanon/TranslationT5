...
NUM_OUTPUTS=3
MODEL_NAME= 't5-base'
CKPT_PATH= 'results/v3/lightning_logs/version_0/checkpoints/epoch=1-step=397-val_loss=0.733.ckpt'
...
df_predictions.to_csv('D:/HAW/Bachelorarbeit/TranslationT5/notebook/results/v3/predictions_'+ MODE +'.tsv' , sep='\t', encoding='utf8')

df_wmt_predictions= pd.DataFrame(english_preds_wmt)
df_wmt_predictions['de']=wmt14_de
df_wmt_predictions.to_csv('D:/HAW/Bachelorarbeit/TranslationT5/notebook/results/v3/predictions_wmt_'+ MODE +'.tsv' , sep='\t', encoding='utf8')
